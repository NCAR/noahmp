...
!---------------------------------------------------------------------
    ...
    integer                 :: snow_compaction_option             = 2 !RAR
    ...
    namelist / NOAHLSM_OFFLINE /    &
         ...
         frozen_soil_option, radiative_transfer_option, snow_albedo_option,  snow_compaction_option,          & !updated by Ronnie Abolafia-Rosenzweig
...
!Added by Ronnie Abolafia-Rosenzweig
